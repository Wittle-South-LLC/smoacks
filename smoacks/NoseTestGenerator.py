...
class NoseTestGenerator:
    ...
    def getJinjaDict(self):
        ...
        result = {
            ...
            'smoacks_test_login': sconfig['env_defaults']['smoacks_test_login'],
            'smoacks_test_user': sconfig['env_defaults']['smoacks_test_user'],
            'smoacks_test_password': sconfig['env_defaults']['smoacks_test_password'],
            'idsString': None,
